<div id="order-confirm">
    ...
    <div class="row row-eq-height">
        ...
        <div class="col-xs-12 col-sm-4" id="check-payment-shipping">
			{*CUSTOM*}
				<div class="fast-pay">
					<a class="btn" href="/bestellvorgang.php#complete-order-button">{lang key="orderLiableToPay" section="checkout"}</a>
				</div>
			{*//CUSTOM*}
    ...
    <form method="post" name="agbform" id="complete_order" action="{get_static_route id='bestellabschluss.php'}">
        ...
        {if $bCheckBox}
            ...
            <hr>
        {/if}
        <div id="complete-order-button" class="row">
                ...
                <div class="panel-wrap basket-well basket-final">
                    <div class="panel panel-primary" id="panel-submit-order">
                        <div class="panel-body">
                            ...
                            <input type="submit" value="{lang key="orderLiableToPay" section="checkout"}"  class="btn btn-primary btn-lg pull-right submit submit_once" />
