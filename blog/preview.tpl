<div itemscope itemtype="https://schema.org/Article" class="panel panel-default">
    <div class="panel-heading hide-overflow">
        <div class="panel-title">
            ...
            <div class="{*CUSTOM pull-right v-box {//CUSTOM*}text-muted ">
    ...
    <div class="panel-body">
        <div class=" row">
            {if !empty($oNewsUebersicht->cPreviewImage)}
                <div class="{*CUSTOM}col-sm-4{CUSTOM*} col-xs-12">
            ...
            {if $oNewsUebersicht->cVorschauText|strip_tags|count_characters > 0}
                <div itemprop="description" class="{*CUSTOM if !empty($oNewsUebersicht->cPreviewImage)}col-sm-8 {//if CUSTOM*}col-xs-12">
